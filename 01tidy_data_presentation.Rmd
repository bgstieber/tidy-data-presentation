...
Find the repository for this presentation [on my GitHub](https://github.com/bgstieber/tidy-data-presentation)
...
Using this scheme, we can order rows based on the first variable and then breaking ties with the second and subsequent (fixed) variables after that.
