...
Then, we can get most forms of untidy data to be tidy by utilizing four verbs of data tidying
  ...
  - [`gather`](https://tidyr.tidyverse.org/reference/gather.html): takes multiple columns, and gathers them into key-value pairs - it makes "wide" data longer
      + See also: [`pivot_longer`](https://tidyr.tidyverse.org/reference/pivot_longer.html) (supercedes `gather` as of [September 2019](https://www.tidyverse.org/blog/2019/09/tidyr-1-0-0/))
  - [`spread`](https://tidyr.tidyverse.org/reference/spread.html):  takes two columns (key & value) and spreads into multiple columns - it makes "long" data wider
      + See also: [`pivot_wider`](https://tidyr.tidyverse.org/reference/pivot_wider.html) (supercedes `spread` as of [September 2019](https://www.tidyverse.org/blog/2019/09/tidyr-1-0-0/))
...
## Five tips to get tidy
 ...
 1. Be able to describe your data set as _one row per __X__ per __Y__ per __Z___
