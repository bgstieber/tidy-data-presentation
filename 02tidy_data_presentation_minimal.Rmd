---
title: "An Introduction to Tidy Data Principles"
author: "Brad Stieber"
date: "Prepared for 2018-11-02 Data Solutions Team Meeting"
header-includes:
- \usepackage{booktabs}
...
Tidy data is __consistent__, __works well with common computational tools__, and __provides a guide for structuring data for analysis__.
...
This is the most complicated form of common untidy data, and requires more massaging.

The table below shows a subset of daily weather data for one weather station in Mexico (MX17004).
...
It has __variables in columns__ (`id`, `year`, `month`), __spread across columns__ (`d1`-`d5`) and __across rows__ (`tmin`, `tmax`).
...
[Broman & Woo (2018)](https://doi.org/10.1080/00031305.2017.1375989) wrote a short paper with 12 tips for organizing data in spreadsheets for sharing, reproducible analysis, and collaboration.
...
## Wrapping up
 ...
 - Be assertive, understanding, and consistent
...
You can find this presentation as well as a longer one on [my GitHub](https://github.com/bgstieber/tidy-data-presentation).
