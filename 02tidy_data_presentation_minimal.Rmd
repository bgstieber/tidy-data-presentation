...
This is the most complicated form of untidy data, and will require more massaging.
...
It has __variables in columns__ (`id`, `year`, `month`), __spread across columns__ (`d1`-`d5`, day) and __across rows__ (`tmin`, `tmax`) (minimum and maximum temperature).
