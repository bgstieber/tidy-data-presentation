...
Requires [`gather`](https://tidyr.tidyverse.org/reference/gather.html)ing, [`spread`](https://tidyr.tidyverse.org/reference/spread.html)ing, and [`unite`](https://tidyr.tidyverse.org/reference/unite.html)-ing.
...
## Wrapping up
 ...
 - Put each dataset in a table, put each variable in a column, and consider how hard would it be to calculate a grouped aggregation
 - Structure and tidy up your data to be manipulated by a computer. Ignore urges to make it easily viewed by a human.
